...
export class ManagerAddDoctorComponent {
  ...
  register(){
    ...
    if(this.username == "" || this.password == "" || this.confirmPassword == "" || this.firstname == "" || this.lastname == "" || this.address == "" || this.phoneNumber == "" || this.email == "" || this.licenceNumber == null || this.branch == "" || this.selectedSpecialization == ""){
      this.message = "All fields are requeired!";
      setTimeout(() => {
        this.message = "";
      }, 2000);
      return;
    ...
    this.specialization = this.selectedSpecialization;
      ...
      if(doctor!=null){
        ...
        if(doctor!=null) {
          ...
          if(this.selectedFile) {
            ...
            this.imagePath = "src\\uploads\\doctors\\default-doctor.png";
